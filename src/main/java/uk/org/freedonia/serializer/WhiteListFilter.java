...
public class WhiteListFilter implements ObjectInputFilter {
    ...
    public Status checkInput(FilterInfo filterInfo) {
        ...
        if(filterInfo.serialClass()== null
                ...
                ||Arrays.asList(AUTOBOX_PRIMITIVES).stream().anyMatch(cl -> cl.equals(filterInfo.serialClass()))
                ||Arrays.asList(whiteListClasses).stream().anyMatch(cl -> cl.equals(filterInfo.serialClass()))
